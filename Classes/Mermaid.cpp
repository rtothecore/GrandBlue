...
bool MermaidLayer::init()
{
	...
	initWithPlist(p_Mermaid, s_Mermaid);
...
bool MermaidLayer::initWithPlist(const char* plist, const char* frameName)
{
...
MermaidLayer* MermaidLayer::clone() const
{
	MermaidLayer* ret = MermaidLayer::create();
...
void MermaidLayer::playMarineLifeSound()
{
	switch(byePoint)
	{
		case 1:
		case 2:
			Sound::playMermaidEffectRand();
			break;
		case 3:
		default:
			Sound::playMermaidEffectWithType(3);
			break;
	}
}